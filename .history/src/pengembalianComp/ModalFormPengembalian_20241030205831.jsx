...
const fetchTransaksi = () => {
  ...
  if (nam === "TransaksiId" && value) {
    try{
      const prevTransaksi = getTransaksiById(value);
      setFormData({
        ...formData,
        TransaksiId: value,
        ClientId: prevTransaksi.ClientId,
        MobilId: prevTransaksi.MobilId,
        KaryawanId: prevTransaksi.KaryawanId,
        batasPeminjaman: prevTransaksi.batasPeminjaman,
        tanggalPengembalian: '' 
      })
    } catch(err) {
      console.error("eror fetch data prevTransaction", err)
    }
  }
  useEffect(() => {
