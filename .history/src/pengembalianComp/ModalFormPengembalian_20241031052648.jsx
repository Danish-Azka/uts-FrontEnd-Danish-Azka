  ...
  useEffect(() => {
    const calculateFine = () => {
        if (formData.tanggalPengembalian && formData.batasPeminjaman) {
            const batasPemi = new Date(formData.batasPeminjaman);
            const tanggalPengembalianDate = new Date(formData.tanggalPengembalian);

            if (tanggalPengembalianDate > batasPemi) {
                const diffInMs = tanggalPengembalianDate - batasPemi;
