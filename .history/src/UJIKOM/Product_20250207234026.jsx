          ...
          <div className='flex flex-col items-center justify-center py-3'>
            <div className='bg-[#E9EAEC] h-full w-11/12  '>
              ...
              <div className='w-full h-[625px]'>
                ...
                <div className='w-full flex h-1/2 justify-center'>
                  <div className='w-2/4 bg-purple-500'>d</div>
                  <div className='w-2/4 bg-yellow-500 overflow-y-auto overflow-x-hidden flex justify-center items-center'>
                  <div className='h-[200px] w-[150px]'>r</div>
                    <div className='h-[200px] w-[150px]'>e</div>
                    <div className='h-[200px] w-[150px]'>t</div>
                    <div className='h-[200px] w-[150px]'>r</div>
                  </div>
                </div>
              </div>
