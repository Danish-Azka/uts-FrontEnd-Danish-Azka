...
const Detail = () => {
  ...
  return (
    <div className="w-full h-full bg-[#f5f5f5]">
      ...
      <div className="max-w-4xl mx-auto mt-10 flex flex-col bg-white shadow-lg rounded-lg">
        <div className="bg-black flex justify-between ">
            <button className="mb-4 px-4 py-2 bg-gray-200 rounded hover:bg-gray-300" onClick={() => navigate(-1)}><XCircle color="red"/></button>
