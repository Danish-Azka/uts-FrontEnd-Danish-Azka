    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-slate-300 rounded-lg h-[700px] w-[900px] shadow-lg">
        ...
        <div className='w-full max-h-full p-1 flex justify-center items-center h-[640px]'>
          <div className="flex flex-col h-[610px] w-2/3 gap-3 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-300 scrollbar-thumb-rounded-lg">
            {data.length > 0 ? (
              data.map((item) => (
