    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-slate-300 rounded-lg h-[700px] w-[900px] shadow-lg">
        ...
        <div className='w-full max-h-full p-3 flex gap-3 justify-between items-center h-[640px]'>
          ...
          <div className='bg-white h-[300px] items-start p-3 rounded-xl w-5/12 KWITANSI'>
            <div className=''>
            ...
            <div className='mt-3'>
              ...
              <p className='text-l'>Product : nama product x jumlah yg dibeli</p>
              <p className='text-l'>Shipping Costs : IDR 100.000</p>
            </div>

            <div className='w-full h-20 border border-black mt-5 p-3 rounded-xl flex items-center'>
              <p className='text-xl'>Total : IDR</p>
            </div>

            <div className='flex justify-end items-center mt-2'>
              <div className='px-3 py-1 bg-black text-white rounded-xl'>CheckOut</div>
            </div>
          </div>
        </div>
      </div>
