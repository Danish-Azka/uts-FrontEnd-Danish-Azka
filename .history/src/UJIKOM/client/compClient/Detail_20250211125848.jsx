...
import ModalCart from "../components/ModalCart"; // Import ModalCart
...
const Detail = () => {
  ...
  return (
    <div className="w-full h-full pb-10 bg-[#f5f5f5]">
      ...
      <div className="w-[600px] mx-auto rounded-xl mt-10 flex flex-col bg-white shadow-lg ">
        ...
        <div className="w-full h-full pb-5 px-10">
          <img
            src={product.gambar}
            alt={product.nama}
