...
const ProductCard = ({ product }) => {
  return (
    <div className="w-full h-[350px] max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          <span className="text-3xl font-bold text-gray-900 dark:text-white">IDR {product.harga.toLocaleString()}</span>
