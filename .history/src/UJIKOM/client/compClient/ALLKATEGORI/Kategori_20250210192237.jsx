        ...
        <div className='flex w-10/12 h-full justify-center items-center'>
          ...
          <p className='text-3xl font-bold text-center mb-5'>K A T E G O R I</p>
            <div className="grid grid-cols-4 gap-4 w-full h-full">
                ...
                <Link to={'/perawatan'}><div className="bg-white shadow-lg rounded-xl h-1/4 flex flex-col gap-2 justify-center items-center">Perawatan & Perlengkapan</div></Link>
                <Link to={'/modifikasi'}><div className="bg-white shadow-lg rounded-xl h-1/4 flex flex-col gap-2 justify-center items-center">Peralatan & Modifikasi</div></Link>
            </div>
          </div>
        </div>
    </div>
