...
import { ShoppingCart, XCircle, HeartIcon } from "lucide-react";
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white w-[500px] rounded-xl shadow-lg">
        ...
        <div className="mt-4 flex justify-between">
          <button className="bg-gray-200 text-gray-800 px-4 py-2 flex justify-between gap-3 rounded-lg hover:bg-gray-300">
            Add to Favorite <HeartIcon color="red"/>
          </button>
          <button className="bg-blue-600 text-white px-4 py-2 flex justify-between gap-3 rounded-lg hover:bg-blue-700">
