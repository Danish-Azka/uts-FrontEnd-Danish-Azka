...
const ProductCard = ({ product }) => {
  return (
    <div className="w-fh-[350px] bg-white border border-gray-200 rounded-lg shadow-xl">
...
const ShopSell = ({ Toko }) => {
  return (
      <div className="rounded-xl w-1/4 shadow-lg h-[150px] flex flex-col justify-center items-center bg-white p-3">
        <img className="w-[100px] h-[100px] object-cover rounded-full" src={Toko.Shop.gambar} alt={Toko.Shop.nama} />
        <p className="text-l font-semibold">{Toko.Shop.nama}</p>
    </div>
  );
};
