...
const Modifikasi = () => {
  return <KategoriList category="Perawatan & Perlengkapan" />;
};


export default Modifikasi<div className="bg-white shadow-lg rounded-xl h-1/4 flex flex-col gap-2 justify-center items-center">Perawatan & Perlengkapan</div>
