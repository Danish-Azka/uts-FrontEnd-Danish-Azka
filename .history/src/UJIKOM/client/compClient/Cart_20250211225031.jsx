  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-slate-300 rounded-lg h-[600px] w-[700px] shadow-lg">
        ...
        <div className="flex flex-col gap-3 h-[] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-300 scrollbar-thumb-rounded-lg">
        {data.length > 0 ? (
            data.map((item, index) => (
              <div key={index} className='h-[250px] bg-white w-full flex flex-col'>
                ...
                <div className='flex flex-row gap-2 p-3'>
                  <div className='w-1/3'>
                    <img className="w-full h-[] bg-yellow-500" src={item.Product?.gambar} alt="" />
                  </div>
                  <div className='w-2/3 h-[] flex justify-start items-center'>
                    <div>
