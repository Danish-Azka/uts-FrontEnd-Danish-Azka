    ...
    <div className="w-full h-full bg-[#f5f5f5]">
      <div>
        ...
        <div className="w-full p-5 h-[350px] gap-3 flex justify-center items-center">
          <div className="w-8/12 h-full bg-white rounded-lg">
            <div className="h-1/6 w-full bg-[#1D1E20] flex justify-between rouned-t-lg items-center px-3">
        ...
        <div className="w-full h-fit gap-3 flex justify-center items-center">
          <div className="w-10/12 h-full bg-white shadow-lg rounded rounded-t-lg p-3">
