        ...
        <div className='flex w-10/12 h-full justify-center items-center'>
          <div className='w-8/12 h-full rounded-lg'>
            <div className="grid grid-cols-4 gap-4 w-full h-full">
                <div className="bg-red-500 rounded-xl w- h-1/4">01</div>
                <div className="bg-red-500 rounded-xl w- h-1/4">02</div>
                <div className="bg-red-500 rounded-xl w- h-1/4">03</div>
                <div className="bg-red-500 rounded-xl w- h-1/4">03</div>
            </div>
          </div>
        </div>
