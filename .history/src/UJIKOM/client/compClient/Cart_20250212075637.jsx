  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-slate-300 rounded-lg h-[700px] w-[700px] shadow-lg">
        <div className="flex justify-between h-[60px] p-5 bg-black rounded-t-lg items-center border-b pb-2 mb-3">
        ...
        <div className='w-full max-h-full flex justify-center items-center h-[640px]'>
          <div className="flex flex-col w-2/3 gap-3 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-300 scrollbar-thumb-rounded-lg">
          {data.length > 0 ? (
            data.map((item, index) => (
              <div key={index} className='h-[250px] bg-white w-full flex flex-col p-3 rounded-lg shadow-md'>
                ...
                <div className='flex gap-3'>
                  <div className='w-1/3'>
                    <img className="w-full h-32 object-cover rounded-lg" src={item.Product?.gambar} alt="" />
                  </div>
          ...
          <div className='bg-red-500 w-1/3'>v</div>
        </div>
      </div>
    </div>  
  );
