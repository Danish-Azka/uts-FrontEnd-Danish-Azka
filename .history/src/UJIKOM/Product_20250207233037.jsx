          ...
          <div className='flex flex-col items-center justify-center py-3'>
            <div className='bg-[#E9EAEC] h-full w-11/12  '>
              ...
              <div className='w-full h-[625px]'>
                ...
                <div className='w-full h-2/3 flex justify-center overflow-y-auto overflow-x-hidden flex justify-center items-center'>
                  <div className='w-full  bg-red-500'>v</div>
                </div>
              </div>
            </div>
          </div>
