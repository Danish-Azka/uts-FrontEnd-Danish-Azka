...
const Product = () => {
  const [products, setProducts] = useState([
    ...
    { id: 3, name: "Busi NGK Iridium", price: "50000", category: "Kelistrikan", image: "https://via.placeholder.com/100" },
    { id: 4, name: "Busi NGK Iridium", price: "50000", category: "Kelistrikan", image: "https://via.placeholder.com/100" },
  ]);
  ...
  };overflow-y-auto overflow-x-hidden flex justify-center items-center
        ...
        <div className='flex flex-col items-center justify-center py-3'>
          <div className='bg-[#E9EAEC] h-[685px] w-11/12 '>
            ...
            <div className='w-full p-4'>
              ...
              {/* Daftar Produk */}
              <div className='grid grid-cols-3 gap-4 mt-4 bg-red-500 overflow-y-auto overflow-x-hidden items-center'>
