            ...
            <div className='bg-[#E9EAEC] h-full w-11/12  '>
              ...
              <div className='w-full h-[625px]'>
                <div className='w-full flex h-1/3 justify-center'>
                  <div className='w-2/4 bg-yellow-500'>d</div>
                  <div className='w-2/4 bg-purple-500'>d</div>
                </div>
                <div className='w-full h-2/3 overflow-y-auto overflow-x-hidden flex justify-center items-center'>
                <div className='h-full'>
            <div className='w-[200px] h-52 mb-2 bg-blue-500'></div>
            <div className='w-[200px] h-52 mb-2 bg-blue-500'></div>
            <div className='w-[200px] h-52 mb-2 bg-blue-500'></div>
            <div className='w-[200px] h-52 mb-2 bg-blue-500'></div>
            <div className='w-[200px] h-52 mb-2 bg-blue-500'></div>
            <div className='w-[200px] h-52 mb-2 bg-blue-500'></div>
            <div className='w-[200px] h-52 mb bg-blue-500'></div>
