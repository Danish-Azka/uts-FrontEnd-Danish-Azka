...
import { IoCar, IoCarSport, IoEyeOffSharp,IoEyeSharp} from 'react-icons/io5';
      ...
      <table className="w-full bg-white border border-gray-300">
        ...
        {data && data.map((item, index) => (
          <tr key={index} className="">
            ...
            <td className="p-3 text-sm tracking-wide font-semibold border border-slate-300 border-r-2 text-center flex gap-2">
              {item.password}
              <button
                type="button"
                onClick={handleshow}
