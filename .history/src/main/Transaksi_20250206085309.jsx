      ...
      <table className="w-full bg-white border border-gray-300">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="p-3 w-[12%] text-sm tracking-wide font-semibold border border-slate-300 border-r-2 ">Durasi Sewa</th>
            <th className="p-3 w-[12%] text-sm tracking-wide font-semibold border border-slate-300 border-r-2 ">Total Biaya</th>
            <th className="p-3 text-sm tracking-wide font-semibold border border-slate-300 border-r-2 ">Client</th>
            <th className="p-3 text-sm tracking-wide font-semibold border border-slate-300 border-r-2 ">Mobil</th>
        ...
        {data && data.map((item, index) => (
          <tr key ={index} className="">
            ...
            <td className="p-3 text-sm tracking-wide font-semibold border border-slate-300 border-r-2 text-center">{item.durasiSewa} Hari</td>
            <td className="p-3 text-sm tracking-wide font-semibold border border-slate-300 border-r-2 text-center">Rp {item.totalBiaya.toLocaleString()}</td>
            <td className="p-3 text-sm tracking-wide font-semibold border border-slate-300 border-r-2 text-center">{item.ClientId} - {item.Client.nama}</td>
            <td className="p-3 text-sm tracking-wide font-semibold border border-slate-300 border-r-2 text-center">{item.MobilId} - {item.Mobil.model}</td>
