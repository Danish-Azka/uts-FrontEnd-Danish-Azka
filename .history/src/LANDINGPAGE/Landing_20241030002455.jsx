...
const fetchMobil = () => {
    ...
    <div className=' w-full h-full pb-10'>
        ...
        {/* CODECARD */}
        <div className='flex container grid grid-cols-4 px-5'>
        {data && data.map((item, index) => (
            <div key={index} class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
            <a href="#">
                <img class="p-8 rounded-t-lg w-full" src={item.gambar} alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
