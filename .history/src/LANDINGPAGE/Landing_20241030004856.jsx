...
const Landing = () => {
    ...
    return (
        <div className='w-full h-full pb-10'>
            ...
            <div className='w-11/12 flex justify-center grid grid-cols-3 gap-5 px-5'>
                {data.map((item, index) => (
                    <div key={index} className=" max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                        ...
                        <div className="px-5 pb-5">
                            ...
                            <div className="flex items-center justify-between">
                                <span className="text-2xl font-bold text-gray-900 dark:text-white">{item.harga}<span className='text-xs'>/Hour</span></span>
