...
const Landing = () => {
    ...
    return (
        <div className='w-full h-full pb-10'>
            ...
            <div className='grid grid-cols-2  bgim '>
                <div className='flex flex-col justify-center items-center px-[70px]'>
                    <p className='text-[55px] bg-red-500 font-bold '>Search and find <br />your best car rental <br />with easy way</p>
                    ...
                    <div className='flex justify-start gap-10 pt-10 w-full'>
                        <div className='w-36 rounded px-2 py-1 bg-slate-400'>f</div>
                        <div className='w-36 rounded px-2 py-1 bg-slate-400'>f</div>
                    </div>
                </div>
