        ...
        <div className='w-full h-full pb-10'>
           ...
           <div className='grid grid-cols-3 gap-10'>
                {data.map((item, index) => (
                    ...
                    <div className='flex align-center justiy-center gap-5 bg-red-500'>
                        <p className='bg-blue-500 inline-flex items-center text-l font-semibold'>Price : Rp {item.harga.toLocaleString()}</p>
