...
const Landing = () => {
    ...
    <div class="w-full mt-[100px] px-10">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a href="https://flowbite.com/" class="flex items-center mb-4 sm">
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">rentCarKuu</span>
            </a>
