    ...
    return (
        <div className='w-full h-full pb-10'>
            ...
            <div className='grid grid-cols-2 bg-red-500 pl-10'>
                <div className='flex justify-center items-center bg-yellow-500 px-[100px]'>
                    <p className='text-[60px] font-semibold '>Search and find your best car rental with easy way</p>
                </div>
