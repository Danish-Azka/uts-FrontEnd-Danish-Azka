...
const fetchMobil = () => {
    ...
    <div className=' w-full h-full'>
        ...
        {data && data.map((item, index) => (
            <div key={index} class="w-full max-w-sm max-h-sm bg-white border border-gray-200 rounded-lg shadow">
            <a href="#">
                <img class="p-8 rounded-t-lg" src={item.gambar} alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
