    ...
    return (
        <div className='w-full h-full pb-10'>
           ...
           <div className='grid grid-cols-3 gap-10'>
                {data.map((item, index) => (
                    <div index={key} classname="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img classname="rounded-t-lg" src={item.gambar} alt="" />
                    </a>
                    <div classname="p-5">
                        <a href="#">
                        ...
                        <a href="#" class=name"inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Read more
