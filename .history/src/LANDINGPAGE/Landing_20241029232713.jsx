  ...
  return (
    <div className=' w-full h-full'>
        ...
        <div className='flex justify-center w-full'>
            <div className='w-full h-[200px] flex justify-center align-middle'><p className='text-[50px] my-auto font-semibold'>Our <br />  Products</p></div>
            <div className='bg-red-500 w-full flex justify-center'><p className='text-sm font-semibold my-auto'>✨ Nikmati Perjalanan Nyaman dengan rentCarKuu! ✨<br />
