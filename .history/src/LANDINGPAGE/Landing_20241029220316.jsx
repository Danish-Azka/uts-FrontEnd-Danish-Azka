  ...
  return (
    <div className=' w-full h-full'>
        ...
        <div className='flex justify-center w-full'>
            <div className='bg-blue-500 w-full h-[200px]'><p className='text-[100px] text-center font-semibold'>Products</p></div>
            <p className='text-[100px] text-center font-semibold'>Products</p></div>
