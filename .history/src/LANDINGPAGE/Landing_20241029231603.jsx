  ...
  return (
    <div className=' w-full h-full'>
        ...
        <div className='flex justify-center w-full'>
            <div className='bg-blue-500 w-full h-[200px] flex justify-center align-middle'><p className='text-[50px] my-auto font-semibold bg-red-500'>Our <br />  Products</p></div>
