            ...
            <div className='grid grid-cols-2 bg-red-500 pl-10'>
                <div className='flex flex-col justify-center items-center bg-yellow-500 px-[70px]'>
                    ...
                    <p className='text-m font-bold'>
                        Mulai dari petualangan singkat hingga perjalanan panjang, kami punya mobil yang siap menemani Anda. Fleksibel, aman, dan terpercaya, semua kebutuhan transportasi Anda ada di sini!</p>
                    </p>
                </div>
