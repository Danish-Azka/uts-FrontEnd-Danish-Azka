...
const Landing = () => {
    ...
    return (
        <div className='w-full h-full pb-10'>
            ...
            <div className='flex justify-center grid grid-cols-2 bg-red-500 mx-10'>
                <div className='flex justify-center items-center'>
                    <p className='text-[50px] font-bold '>Search and find your best car rental with easy way</p>
                </div>
                <div className='flex justify-center items-center'>
