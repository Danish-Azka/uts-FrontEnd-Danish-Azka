...
const Landing = () => {
    ...
    return (
        <div className='w-full h-full pb-10'>
            ...
            {/* CODECARD with grid and limit to 3 per row */}
            <div className='grid grid-cols-3 gap-5 px-5'>
                {data.map((item, index) => (
                    <div key={index} className="max-w-sm h-[350px] bg-white border border-gray-200 rounded-lg shadow">
                        <a href="#">
                            <img className="p-8 rounded-t-lg w-full" src={item.gambar} alt="product image" />
                        </a>
