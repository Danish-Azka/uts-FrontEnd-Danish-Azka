...
const Landing = () => {
    ...
    <div class="w-full mt-[100px] px-10">
        <div class="flex items-center justify-between px-[60px]">
                <span class="flex gap text-2xl font-semibold items-center"><img src={aa} className='w-[100px]' />rentCarKuu</span>
        ...
        <div style={"width: 100%"}}><iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=pamulang,%20showroom,%20jl.%20panjajaran%20no.1+(rentCarKuu)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">cat gps tracker</a></iframe></div>
        </div>
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a class="hover:underline">rentCarKuu™</a>. All Rights Reserved.</span>
    </div>
        </div>
