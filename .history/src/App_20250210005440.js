...
import { KategoriTemplate } from './UJIKOM/client/compClient/KategoriTemplate';
import Sparepart from './UJIKOM/client/compClient/Sparepart';
  ...
  return (
    ...
    <BrowserRouter basename="/uts-FrontEnd-Danish-Azka/">
      ...
      <Routes>
        ...
        <Route path="/tp" element={<Sparepart/>} />
