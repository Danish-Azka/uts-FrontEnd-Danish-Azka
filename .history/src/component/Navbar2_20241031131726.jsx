  ...
  return (
    <>
       <div className='flex items-center justify-between w-[92%] mx-auto'>
          ...
          <div className={`absolute bg-red-500 lg:static h-fit  py- lg:py-0 lg:h-fit left-0  w-full lg:w-fit flex items-center lg:mx-0 bg lg:transition-none transition-all duration-500 ease-in lg:bg-transparent ${open ? "top-[60px] opacity-100" : "top-[-200px] opacity-100"}`}>
