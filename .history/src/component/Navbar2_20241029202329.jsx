       ...
       <div className='flex py-1 items-center justify-between w-[92%] mx-auto'>
          ...
          <div className='flex items-center gap-2 lg:gap-5'>
            <div className='flex items-center'>
              ...
              <p className='lg:flex items-center text-white
              '
              \ hidden'>Language <span><FaAngleDown className='mt-1'/></span></p>
            /div>            <div><button style={{backgroundColor:"#fc3d60"}} className='px-5 rounded-xl py-1 text-white font-semibold lg:block hidden'>Get Started</button></div>
