    ...
    <div className='h-full w-full'>
      ...
      <div className='w-full h-[70%] bg-[rgb(36,42,66)] py-7'>
        <div className='w-full h-full ps-3 cursor-default'>
          <SidebarItem className="" path="/display" icon={IoHome} label="Home" />
          <SidebarItem className="" path="/karyawan" icon={IoPerson} label="Partnership" />
          <SidebarItem className="" path="/client" icon={IoPeople} label="Client" />
          <SidebarItem className="" path="/mobil" icon={IoCarSport} label="Car" />
          <SidebarItem className="" path="/transaksi" icon={IoFolderOpen} label="Transaction" />
          <SidebarItem className="" path="/pengembalian" icon={IoReturnDownBack} label="Return" />
        </div>
