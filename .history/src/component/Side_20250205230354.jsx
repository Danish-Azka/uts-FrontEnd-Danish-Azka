    ...
    <div className='h-full w-full'>
      ...
      <div className='w-full h-[70%] bg-[rgb(36,42,66)] py-7'>
        <div className='w-full h-full ps-3 cursor-default'>
          <SidebarItem className="w-full h-[25%] rounded-s-xl sideButt" path="/display" icon={IoHome} label="Home" />
          <SidebarItem className="w-full h-[25%] rounded-s-xl sideButt" path="/karyawan" icon={IoPerson} label="Partnership" />
          <SidebarItem className="w-full h-[25%] rounded-s-xl sideButt" path="/client" icon={IoPeople} label="Client" />
          <SidebarItem className="w-full h-[25%] rounded-s-xl sideButt" path="/mobil" icon={IoCarSport} label="Car" />
          <SidebarItem className="w-full h-[25%] rounded-s-xl sideButt" path="/transaksi" icon={IoFolderOpen} label="Transaction" />
          <SidebarItem className="w-full h-[25%] rounded-s-xl sideButt" path="/pengembalian" icon={IoReturnDownBack} label="Return" />
        </div>
